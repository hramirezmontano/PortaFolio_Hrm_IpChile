...
<head>
  ...
  <title>Mi Portafolio - Hugo Ramírez Montaño</title>
  <meta name="description" content="Portafolio Profesional de Hugo Ramírez Montaño - Analista Programador y Desarrollador Full-Stack">
...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="Experiencias" class="resume section">
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Trayectoria profesional destacada en desarrollo de software, análisis de sistemas e infraestructura TI.</p>
      </div>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      <p>
        © 2026 Hugo Ramírez Montaño | Designed by <a href="#" target="_blank" rel="noopener">AplicWeb</a>
      </p>
    </div>
  </footer>
